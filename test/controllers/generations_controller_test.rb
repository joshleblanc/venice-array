...
class GenerationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create generation" do
    assert_difference("Generation.count") do
      post generations_url, params: { generation: { generation_array_id: @generation.generation_array_id, style_preset: @generation.style_preset, user_id: @generation.user_id } }
    end
  ...
  test "should update generation" do
    patch generation_url(@generation), params: { generation: { generation_array_id: @generation.generation_array_id, style_preset: @generation.style_preset, user_id: @generation.user_id } }
