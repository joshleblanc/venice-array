module BadgeHelper
  BADGE_CLASSES = "inline-flex items-center rounded-md px-2 py-1 text-xs font-medium inset-ring".freeze

  COLOR_CLASSES = {
    gray: "bg-gray-50 text-gray-700 inset-ring-gray-500/10 dark:bg-gray-400/10 dark:text-gray-400 dark:inset-ring-gray-400/20".freeze,
    red: "bg-red-50 text-red-700 inset-ring-red-600/10 dark:bg-red-400/10 dark:text-red-400 dark:inset-ring-red-400/20".freeze,
    yellow: "bg-yellow-50 text-yellow-800 inset-ring-yellow-600/20 dark:bg-yellow-400/10 dark:text-yellow-500 dark:inset-ring-yellow-400/20".freeze,
